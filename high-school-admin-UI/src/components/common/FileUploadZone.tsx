      ...
      {!currentFile ? (
        <div
          ...
          className={`relative border-2 border-dashed rounded-2xl p-4 text-center cursor-pointer transition flex flex-col items-center justify-center gap-2 ${
            isDragging
              ? 'border-brand-500 bg-surface-strong'
              : 'border-surface hover:border-brand-400 bg-surface hover:bg-surface-strong'
        ...
        <div className="flex items-center justify-between p-3 rounded-2xl border border-surface bg-surface-strong">
          <div className="flex items-center gap-3 min-w-0">
            <div className="p-2 rounded-xl bg-surface text-success">
          ...
          <button
            ...
            disabled={disabled}
            className="p-1.5 rounded-lg text-secondary hover:text-error hover:bg-surface transition"
