...
export const statCards: StatCard[] = [
  {
    ...
    footerLabel: 'Active students in all grades',
    icon: 'GraduationCap',
    tint: 'blue',
  ...
  },
  {
    ...
    deltaDirection: 'up',
    deltaLabel: 'vs. last semester',
    footerLabel: 'Full-time & part-time teachers',
    icon: 'Users',
    tint: 'emerald',
  ...
  },
  {
    ...
    deltaDirection: 'up',
    deltaLabel: 'vs. last semester',
    footerLabel: 'Active classes this academic year',
    icon: 'BookOpen',
    tint: 'purple',
  ...
  },
  {
    ...
    deltaDirection: 'up',
    deltaLabel: 'vs. last semester',
    footerLabel: 'Average student attendance',
    icon: 'FileText',
    tint: 'orange',
  ...
  },
  {
    ...
    deltaDirection: 'up',
    deltaLabel: 'vs. last semester',
    footerLabel: 'Overall academic performance',
    icon: 'Star',
    tint: 'pink',
  ...
  },
  {
    ...
    deltaDirection: 'up',
    deltaLabel: 'vs. last semester',
    footerLabel: 'On-time submission rate',
    icon: 'FileCheck2',
    tint: 'blue',
  ...
  },
  {
    ...
    deltaDirection: 'up',
    deltaLabel: 'vs. last semester',
    footerLabel: 'Students with GPA ≥ 3.5',
    icon: 'Trophy',
    tint: 'purple',
    miniGraphicType: 'users-purple',
  },
  {
    id: 'events',
