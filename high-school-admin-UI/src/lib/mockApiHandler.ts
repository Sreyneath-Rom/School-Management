...
let subjectsStore: SubjectItem[] = [
  // --------------------------------------------------------------------------
  // LOWER SECONDARY SCHOOL (Grades 7–9 / អនុវិទ្យាល័យ) - MoEYS National Curriculum
  // --------------------------------------------------------------------------
  {
    id: 's-khm-709',
  ...
  },
  {
    ...
    weeklyHours: 5,
    gradeLevel: 'Grades 7–9 (Lower Secondary)',
    description: 'Builds core numerical numeracy, arithmetic operations, basic algebra, introductory geometry, and problem-solving skills.',
    color: 'amber',
    teachers: [
      { id: 't-mth-1', name: 'Rithy Chan', label: 'RC', color: 'bg-amber-500' },
      { id: 't-mth-2', name: 'Dara Heng', label: 'DH', color: 'bg-emerald-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-sci-709',
    name: 'General Science (វិទ្យាសាស្ត្រទូទៅ)',
    code: 'SCI-709',
    department: 'Science',
    category: 'Core',
    credits: 4,
    weeklyHours: 4,
    gradeLevel: 'Grades 7–9 (Lower Secondary)',
    description: 'Covers fundamental principles across general biology, earth science, introductory physics, and basic chemistry concepts.',
    color: 'emerald',
    teachers: [
      { id: 't1', name: 'Dr. John Whitfield', label: 'JW', color: 'bg-emerald-500' },
      { id: 't-sci-1', name: 'Sovannara Kem', label: 'SK', color: 'bg-teal-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-soc-709',
    name: 'Social Studies (សិក្សាសង្គម)',
    code: 'SOC-709',
    ...
    weeklyHours: 4,
    gradeLevel: 'Grades 7–9 (Lower Secondary)',
    description: 'Explores Cambodian history, national heritage, local geography, and social sciences.',
    color: 'violet',
    teachers: [
      { id: 't6', name: 'Sarah Parker', label: 'SP', color: 'bg-amber-500' },
      { id: 't-soc-1', name: 'Vicheka Nhem', label: 'VN', color: 'bg-violet-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-eng-709',
    name: 'Foreign Language - English (ភាសាអង់គ្លេស)',
    code: 'ENG-709',
    ...
    weeklyHours: 3,
    gradeLevel: 'Grades 7–9 (Lower Secondary)',
    description: 'Builds foundational communicative English proficiency, vocabulary acquisition, listening, and basic composition.',
    color: 'sky',
    teachers: [
      { id: 't9', name: 'Claire Bennett', label: 'CB', color: 'bg-rose-500' },
      { id: 't-eng-1', name: 'Kosal Mom', label: 'KM', color: 'bg-sky-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-fra-709',
    name: 'Foreign Language - French (ភាសាបារាំង)',
    code: 'FRA-709',
    department: 'Foreign Languages',
    category: 'Elective',
    credits: 3,
    weeklyHours: 3,
    gradeLevel: 'Grades 7–9 (Lower Secondary)',
    description: 'Official alternative foreign language studying French grammar, conversational dialogues, and Francophonie culture.',
    color: 'blue',
    teachers: [{ id: 't-fra-1', name: 'Mme. Monique Laurent', label: 'ML', color: 'bg-blue-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-lpe-709',
    name: 'Life Skills & Physical Education (បំណិនជីវិត និងអប់រំកាយ-កីឡា)',
    code: 'LPE-709',
    ...
    weeklyHours: 2,
    gradeLevel: 'Grades 7–9 (Lower Secondary)',
    description: 'Includes health education, morals-civics, sports, adolescent physical conditioning, and practical life skills.',
    color: 'rose',
    teachers: [{ id: 't-pe-1', name: 'Sambath Ouch', label: 'SO', color: 'bg-rose-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },

  // --------------------------------------------------------------------------
  // UPPER SECONDARY SCHOOL (Grades 10–12 / វិទ្យាល័យ) - MoEYS National Curriculum
  // --------------------------------------------------------------------------
  {
    id: 's-khm-1012',
    name: 'Advanced Khmer Literature (ភាសាខ្មែរ និងអក្សរសិល្ប៍កម្រិតខ្ពស់)',
    code: 'KHM-1012',
    department: 'Languages & Humanities',
    category: 'Core',
    credits: 5,
    weeklyHours: 5,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Advanced study of language, poetry, analytical prose, and classical texts (Tum Teav, Reamker) preparing for the national Bac II exam.',
    color: 'indigo',
    teachers: [
      { id: 't-khm-1', name: 'Sokha Chea', label: 'SC', color: 'bg-indigo-500' },
      { id: 't-khm-3', name: 'Kalyan Sem', label: 'KS', color: 'bg-purple-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-mth-1012',
    name: 'Advanced Mathematics (គណិតវិទ្យាកម្រិតខ្ពស់)',
    code: 'MTH-1012',
    department: 'Mathematics',
    ...
    weeklyHours: 6,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Higher-level algebra, analytic geometry, trigonometry, vectors, differential and integral calculus prep for Bac II.',
    color: 'amber',
    teachers: [
  ...
  },
  {
    ...
    weeklyHours: 4,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Specialized course studying mechanics, kinematics, thermodynamics, electromagnetism, wave optics, and atomic physics.',
    color: 'sky',
    teachers: [
      { id: 't-phy-1', name: 'Dr. Vicheth Keo', label: 'VK', color: 'bg-sky-500' },
      { id: 't1', name: 'Dr. John Whitfield', label: 'JW', color: 'bg-emerald-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    ...
    weeklyHours: 4,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Specialized course in atomic structure, stoichiometry, chemical bonding, thermochemistry, reaction kinetics, and organic chemistry.',
    color: 'teal',
    teachers: [
      { id: 't-chm-1', name: 'Dr. Chanthy Suon', label: 'CS', color: 'bg-teal-500' },
      { id: 't-chm-2', name: 'Sopheak Tuy', label: 'ST', color: 'bg-cyan-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    ...
    weeklyHours: 4,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Specialized course in molecular genetics, cytology, human anatomy, physiology, and evolutionary ecology.',
    color: 'emerald',
    teachers: [
      { id: 't-bio-1', name: 'Dr. Alice Liu', label: 'AL', color: 'bg-violet-500' },
      { id: 't-bio-2', name: 'Sokunthea Prum', label: 'SP', color: 'bg-emerald-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-ees-1012',
    name: 'Earth & Environmental Science (ផែនដី និងបរិស្ថានវិទ្យា)',
    code: 'EES-1012',
    department: 'Science',
    category: 'Core',
    credits: 3,
    weeklyHours: 3,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Specialized course in geology, plate tectonics, meteorology, hydrology, astronomy, and Cambodian conservation science.',
    color: 'green',
    teachers: [{ id: 't-ees-1', name: 'Rathana Seng', label: 'RS', color: 'bg-green-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-his-1012',
    name: 'History (ប្រវត្តិវិទ្យា)',
    code: 'HIS-1012',
    department: 'Social Studies',
    category: 'Core',
    credits: 4,
    weeklyHours: 4,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Advanced study of Cambodian history from Angkorian civilization to modern statehood, ASEAN affairs, and world history.',
    color: 'violet',
    teachers: [
      { id: 't-his-1', name: 'Vannak Yin', label: 'VY', color: 'bg-violet-500' },
      { id: 't7', name: 'David Miller', label: 'DM', color: 'bg-amber-500' },
    ],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    ...
    weeklyHours: 3,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Detailed analysis of Cambodian physical landscapes, ASEAN economic geography, demographics, and global spatial development.',
    color: 'fuchsia',
    teachers: [{ id: 't-geo-1', name: 'Sokly Meas', label: 'SM', color: 'bg-fuchsia-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-mor-1012',
    name: 'Moral-Civics (សីលធម៌-ពលរដ្ឋវិជ្ជា)',
    code: 'MOR-1012',
    department: 'Social Studies',
    category: 'Core',
    credits: 3,
    weeklyHours: 3,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Studies in ethics, civic duties, human rights, the Cambodian constitution, democratic values, and peace education.',
    color: 'orange',
    teachers: [{ id: 't-mor-1', name: 'Chhayrith Bun', label: 'CB', color: 'bg-orange-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-eng-1012',
    name: 'Foreign Language - English (ភាសាអង់គ្លេសកម្រិតខ្ពស់)',
    code: 'ENG-1012',
    department: 'Foreign Languages',
    category: 'Core',
    credits: 4,
    weeklyHours: 4,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Continued intensive study of English, academic essay composition, technical comprehension, and international communication skills.',
    color: 'cyan',
    teachers: [{ id: 't-eng-2', name: 'Panha Sin', label: 'PS', color: 'bg-cyan-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
  },
  {
    id: 's-ict-1012',
    name: 'Information & Communication Technology - ICT (បច្ចេកវិទ្យាព័ត៌មាន និងសារគមនាគមន៍)',
    code: 'ICT-1012',
    ...
    weeklyHours: 3,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Basic computer literacy, software suites, cyber security, computational logic, data analysis, and coding skills.',
    color: 'purple',
  ...
  {
    id: 's-hpe-1012',
    name: 'Health & Physical Education (អប់រំកាយ និងសុខភាព)',
    code: 'HPE-1012',
    department: 'Health & Physical Education',
    category: 'Core',
    credits: 2,
    weeklyHours: 2,
    gradeLevel: 'Grades 10–12 (Upper Secondary)',
    description: 'Sports, athletic training, physical wellness, community hygiene, and adolescent health studies.',
    color: 'rose',
    teachers: [{ id: 't-pe-1', name: 'Sambath Ouch', label: 'SO', color: 'bg-rose-500' }],
    createdAt: '2024-01-10T00:00:00.000Z',
    updatedAt: '2024-01-10T00:00:00.000Z',
