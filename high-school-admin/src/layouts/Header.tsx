...
export default function Header({
  ...
  //
  // All loading, cross-tab/same-tab syncing with TranslationManager, and the
  // t() lookup live in the shared useTranslations hook (src/i18n) so this
  // logic only exists once in the codebase.
  // ==========================================================================
