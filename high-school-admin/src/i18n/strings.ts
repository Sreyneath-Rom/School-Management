...
export const STRINGS = [
  ...
  { key: 'sidebar.schoolSetup', category: 'Sidebar', en: 'School Setup', es: 'Configuración de la Escuela', fr: 'Configuration de l\'école', de: 'Schuleinrichtung', pt: 'Configuração da Escola', it: 'Configurazione della Scuola', ja: '学校設定', zh: '学校设置', ar: 'إعداد المدرسة', hi: 'स्कूल सेटअप' },
