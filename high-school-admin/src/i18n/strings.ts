...
export const STRINGS = [
  ...
  { key: 'sidebar.gradeLevels', category: 'Sidebar', en: 'Grade Levels', es: 'Niveles de Grado', fr: 'Niveaux scolaires', de: 'Klassenstufen', pt: 'Níveis de Ensino', it: 'Livelli di Grado', ja: '学年水準', zh: '年级阶段', ar: 'المراحل الدراسية', hi: 'कक्षा स्तर' },
