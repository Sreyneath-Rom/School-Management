...
export default function PendingExcuseRequests() {
  return (
    <section className="rounded-[28px] glass-sm p-6">
      <div className="mb-6">
        <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">Pending Excuse Requests</h2>
        <p className="text-sm text-slate-600 dark:text-slate-400">Review parent-submitted absence excuses</p>
      </div>
